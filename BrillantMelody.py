...
class BrilliantMelody:
    ...
    def select_mode(self):
        ...
        self.reset_game()  # Resetar o estado do jogo ao selecionar um novo modo
        self.start_game()   # Iniciar o novo jogo
    ...
    def round_complete(self):
        ...
        if self.single_player:
            ...
            self.game_speed = max(1000 - (self.level - 1) * LEVEL_INCREMENT, MAX_SPEED)
            user_sequence.clear()
            player_turn = 2 if player_turn == 1 else 1  # Troca de turno
            self.root.after(1000, self.next_round)
    ...
    def player_failed(self):
        ...
        if self.single_player:
            ...
            if lives[player_turn] == 0:
                ...
                self.game_speed = GAME_SPEED  # Reinicia a velocidade do jogo
                player_turn = 2 if player_turn == 1 else 1  # Troca de turno
                user_sequence.clear()  # Limpa a sequência do jogador atual
                self.root.after(1000, self.next_round)
